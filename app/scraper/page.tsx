...
function getDefaultIndustries(): string[] {
  return [
    ...
    'Security Services',
    'Heavy Manufacturing & Production',
    'Metal Fabrication & Engineering',
    'Plastic & Polymer Manufacturing',
    'Chemical & Industrial Gas Production',
    ...
    'Material Handling & Forklift Suppliers',
    'Non-Destructive Testing (NDT) Services',
    'Industrial Pump & Valve Suppliers',
    'Automotive Component Manufacturing',
    'Truck Body Builders & Heavy Vehicle Repair',
    ...
    'Renewable Energy & Solar Contractors',
    'Telecommunications Infrastructure',
    'Property Development',
    'Scaffolding & Formwork Suppliers',
    'Ready-Mix Concrete Suppliers',
    'Agricultural Equipment & Machinery',
    'Fertilizer & Pesticide Distributors',
    'Irrigation System Specialists',
    'Animal Feed & Nutrition Manufacturers',
    'Grain Handling & Silo Services',
    'Abattoirs & Meat Wholesale',
    'Scientific Laboratory & Testing Services',
