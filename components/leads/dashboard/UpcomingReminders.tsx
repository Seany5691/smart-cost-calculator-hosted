  ...
  return (
    <div className="space-y-4">
      ...
      {filteredItems.length === 0 ? (
        ...
        <div className="space-y-3 max-h-[600px] overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-emerald-500/50 scrollbar-track-white/10 hover:scrollbar-thumb-emerald-500/70">
