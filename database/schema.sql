...
CREATE TABLE IF NOT EXISTS users (
  ...
  role VARCHAR(50) NOT NULL CHECK (role IN ('admin', 'manager', 'user', 'telesales')),
...
-- Insert super admin user (Camryn)
-- Password: Elliot6242! (hashed with bcrypt)
-- Note: This will be properly hashed during migration
INSERT INTO users (username, password, role, name, email, is_super_admin, is_active)
VALUES ('Camryn', '$2b$10$placeholder', 'admin', 'Camryn', 'camryn@example.com', true, true)
